...
```
parallels@ubuntu-linux-20-04-desktop:~$ docker run -d --name=pg_13 -p 4432:5432 \
				-e POSTGRES_PASSWORD=secret \																	-e PGDATA=/pgdata -v /pgdata13:/pgdata \															-v /pgbkp13:/pgbkp \																		postgres:13
